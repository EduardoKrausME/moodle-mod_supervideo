...
$string['markers_error'] = 'Utilice un marcador por línea en el formato hora | etiqueta | skip. Los tiempos deben ser únicos y pueden usar segundos, MM:SS o HH:MM:SS.';
$string['markers_help'] = 'Agregue un marcador por línea usando <code>time | label</code>. Agregue <code>| skip</code> para mostrar un botón después de ese marcador que salta al siguiente marcador.<br><br>Ejemplo:<br><code>00:30 | Question | skip<br>01:30 | Answer<br>02:10 | Next activity</code><br><br>El tiempo se puede ingresar como segundos, MM:SS, o HH:MM:SS. Los marcadores se ordenan automáticamente.';
$string['markers_jump'] = 'Saltar al siguiente marcador';
...
$string['overview_requiredviewing'] = 'Visualización requerida';
...
$string['privacy:progress'] = 'Progreso de visualización de vídeo';
...
$string['showmap_desc'] = 'Si está marcado, muestra el mapa después del reproductor de video.';
...
$string['your_map_view'] = 'Tu Ver mapa:';
