...
$string['repository_ottflix_disable'] = 'O repositório OttFlix está instalado, mas não está habilitado. <a href="{$a}/admin/repository.php">Clique aqui para ativá-lo</a> e facilitar a organização dos seus vídeos e arquivos.';
$string['repository_ottflix_notinstall'] = 'O repositório OttFlix não está instalado. Recomendamos <a href="https://moodle.org/plugins/repository_ottflix">clicar aqui</a> para instalá-lo e simplificar o acesso e a organização dos seus vídeos e arquivos.';
$string['repository_pandavideo_disable'] = 'O repositório Panda Video está instalado, mas não está habilitado. <a href="{$a}/admin/repository.php">Clique aqui para ativá-lo</a> e otimizar o uso dos seus vídeos.';
$string['repository_pandavideo_notinstall'] = 'O repositório Panda Video não está instalado. Recomendamos <a href="https://moodle.org/plugins/repository_pandavideo">clicar aqui</a> para instalá-lo e facilitar a localização e o uso dos seus vídeos.';
