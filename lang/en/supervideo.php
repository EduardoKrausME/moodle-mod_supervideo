...
$string['panda_title_desc'] = 'Integration with the Panda Videos streaming service to display content hosted on the platform.';
$string['panda_token'] = 'Access Token';
$string['panda_token_desc'] = 'Enter the authentication token provided by the Panda Videos platform to enable secure integration with Moodle.';
