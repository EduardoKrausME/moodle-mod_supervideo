...
<head>
    ...
    <title><?php echo get_string( "app_title" ); ?></title>
    ...
    <script src="js/recorder-save.js"></script>
    <script src="js/time-stamp.js"></script>
...
<div id="app" class="record-parado">
    ...
    <img class="logo" src="img/logo.svg" alt="<?php echo get_string( "logo_title" ); ?>"
         title="<?php echo get_string( "logo_title" ); ?>">
        ...
        <div class="controles-layout">
            <div id="ppt-select-icon">
                <img src="img/icons/presentation/presentation.svg"
                     alt="<?php echo get_string( "selecionar_slide" ); ?>"
                     title="<?php echo get_string( "selecionar_slide" ); ?>">
            </div>
            <img src="img/layout/layout-only-cam.jpg" data-layout="layout-only-cam"
                 alt="<?php echo get_string( "layout_cam" ); ?>"
                 title="<?php echo get_string( "layout_cam" ); ?>"
                 class="layout layout-only">
            <img src="img/layout/layout-only-ppt.jpg" data-layout="layout-only-ppt"
                 alt="<?php echo get_string( "layout_presentation" ); ?>"
                 title="<?php echo get_string( "layout_presentation" ); ?>"
                 class="layout layout-only">
            <img src="img/layout/layout-dual-1.jpg" data-layout="layout-dual-1"
                 alt="<?php echo get_string( "layout_1" ); ?>"
                 title="<?php echo get_string( "layout_1" ); ?>"
                 class="layout">
            <!--img src="img/layout/layout-dual-2.jpg" data-layout="layout-dual-2"
                    alt="<?php echo get_string( "layout_2" ); ?>"
                    title="<?php echo get_string( "layout_2" ); ?>"
                 class="layout"-->

            <img src="img/layout/layout-pip-3.jpg" data-layout="layout-pip-3"
                 alt="<?php echo get_string( "layout_5" ); ?>"
                 title="<?php echo get_string( "layout_5" ); ?>"
                 class="layout">
            <img src="img/layout/layout-pip-2.jpg" data-layout="layout-pip-2"
                 alt="<?php echo get_string( "layout_4" ); ?>"
                 title="<?php echo get_string( "layout_4" ); ?>"
                 class="layout">
            <img src="img/layout/layout-pip-4.jpg" data-layout="layout-pip-4"
                 alt="<?php echo get_string( "layout_6" ); ?>"
                 title="<?php echo get_string( "layout_6" ); ?>"
                 class="layout">
            <img src="img/layout/layout-pip-1.jpg" data-layout="layout-pip-1"
                 alt="<?php echo get_string( "layout_3" ); ?>"
                 title="<?php echo get_string( "layout_3" ); ?>"
                 class="layout">
            ...
            <div class="controle-device btn-control btn-concluir"
                 title="<?php echo get_string( "finalizar_gravacao" ); ?>"
                 style="display:none">
                <div id="btn-stop" class="btn">
                    <?php echo get_string( "finalizar" ); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="configurations">
        ...
        <div class="controles-device">
            <div id="select-video-area" class="controle-device background">
                ...
                <div class="off"><?php echo get_string( "desligado" ); ?></div>
            </div>

            <div id="cam-invert-area" class="controle-device cam-config-area">
                <?php echo get_string( "inverter_camera" ); ?>
            ...
            <div id="cam-round-area" class="controle-device cam-config-area">
                <?php echo get_string( "camera_redonda" ); ?>
                <label class='el-switch small'>
            ...
            <div id="cam-size-area" class="controle-device cam-config-area"
                 style="gap:16px;">
                <?php echo get_string( "tamanho_camera" ); ?>
            ...
            <div id="systemAudio-area" class="controle-device mic-config-area">
                <?php echo get_string( "compartilhar_audio_sistema" ); ?>
                <label class='el-switch small'>
                    <input type="checkbox" id="cam-round">
                    <span class='el-switch-style'></span>
                </label>
            ...
            <div id="countdown-area" class="controle-device"
                ...
                <?php echo get_string( "contagem_regressiva" ); ?>
                <label class='el-switch small'>
            ...
            <div class="controle-device btn-control"
                ...
                <div id="btn-record" class="btn" title="<?php echo get_string( "iniciar_gravacao" ); ?>">
                    <img src="img/icons/controle/record.svg">
                    <?php echo get_string( "iniciar_gravacao" ); ?>
                </div>
            </div>
            <div class="controle-device btn-control"
                 style="margin-bottom:10px;">
                <div id="btn-record-fullscreen" class="btn"
                     title="<?php echo get_string( "iniciar_gravacao_fullscreen" ); ?>">
                    <img src="img/icons/controle/fullscreen.svg">
                    <?php echo get_string( "iniciar_gravacao_fullscreen" ); ?>
                </div>
            </div>
            <div class="controle-device btn-control btn-save"
                 style="margin-bottom:10px;display:none">
                <div id="btn-save" class="btn" title="<?php echo get_string( "salvar_ottflix" ); ?>">
                    <?php echo get_string( "salvar_ottflix" ); ?>
                </div>
            </div>
        </div>
    </div>
...
<div id="sleep-allow-video" class="app-status">
    <div class="info">
        <span>
            <img src="img/icons/controle/mic.svg" alt="<?php echo get_string( "microfone" ); ?>"
                 title="<?php echo get_string( "microfone" ); ?>"></span>
        <span>
            <img src="img/icons/controle/cam.svg" alt="<?php echo get_string( "camera" ); ?>"
                 title="<?php echo get_string( "camera" ); ?>"></span>
        <h3 class="info-title"><?php echo get_string( "kapture_precisa_camera" ); ?></h3>
        <span class="info-text"><?php echo get_string( "aprovar_permissao" ); ?></span>
    </div>
</div>
<div id="error-allow-video" class="app-status">
    <div class="info">
        ...
        <span>
            <img src="img/icons/controle/cam.svg" alt="<?php echo get_string( "camera" ); ?>"
                 title="<?php echo get_string( "camera" ); ?>"></span>
        <h3 class="info-title"><?php echo get_string( "erro_camera_microfone." ); ?></h3>
        <span class="info-text"><?php echo get_string( "entre_contato_suporte_erro" ); ?><br>
            ...
            <div>
                <label for="select-video">
                    <img src="img/icons/controle/cam.svg"
                         alt="<?php echo get_string( "camera" ); ?>"
                         title="<?php echo get_string( "camera" ); ?>"></label>
                <select name="camera" id="select-video"></select>
            </div>
            <div>
                <label for="select-audio">
                    <img src="img/icons/controle/mic.svg"
                         alt="<?php echo get_string( "microfone" ); ?>"
                         title="<?php echo get_string( "microfone" ); ?>"></label>
                <select name="microfone" id="select-audio"></select>
            </div>
        </div>
...
<div id="error-video" class="app-status">
    <div class="info">
        <h3 class="info-title"><?php echo get_string( "erro" ); ?></h3>
...
<div class="mobileViewOnly">
    <img class="mobileViewImg" src="img/mobileView.png"
         alt="<?php echo get_string( "nao_suportado_celular" ); ?>"
         title="<?php echo get_string( "nao_suportado_celular" ); ?>">
    <div class="headText"><?php echo get_string( "nao_suportado_celular" ); ?></div>
</div>
